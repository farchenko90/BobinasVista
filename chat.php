...
<head>
    ...
    /*
    * chat para chatear con los usuarios
    */
    ...
    $(document).ready(function(){
      ...
      setInterval("verMensaje(geturl,idcli)",3000);//este es de cliente a usuario
      setInterval("cambiarEstadoVisto(geturl, idcli)",10000);
...
//para visualizarla una vez haya subido
    ...
    /*
    * Id del cliente en chat usuario
    */
    function usuariochat1(id){
      //alert(id)
      jQuery.ajax({
           type: "GET",
           ...
           success: function (data, status, jqXHR) {
               ...
               if(data!=null){
                  ...
                  clienteid = data.Id_usu;
                  nomusu = data.Nom_usu;
                  //alert(geturl+" "+idcli+" "+clienteid)
                  verMensaje(geturl,idcli);
                  cambiarEstadoVisto(geturl, idcli);
               }
    ...
    function vaciarchatcliente(){
      //alert(idcli+" "+nom_usu)
      jQuery.ajax({
         type: "DELETE",
         url: servidor+"chatcliente/eliminarcli/"+idcli+"/"+nom_usu,
         dataType: "json",
         success: function (data, status, jqXHR) {
             if(data.estado == 1){
...
<br>
  ...
  <div  class="container-fluid">
          ...
          <div class="col-xs-12 col-md-8">
            ...
            <!--<div class="btn-group" style="margin-top: -28%; margin-left: 0%">
              ...
              <ul class="dropdown-menu">
                <li><a href="" onclick="javascript:vaciarchatcliente()">Vaciar Chat</a></li>
                <li><a href="" onclick="javascript:window.close();">Salir Del Chat</a></li>
              </ul>
            </div>-->
            <div class="btn-group open" style="margin-top: -28%; margin-left: 0%">
              ...
              <ul class="dropdown-menu">
                <li><a href="" onclick="javascript:vaciarchatcliente()"><i class="fa fa-trash-o fa-fw"></i> Vaciar Chat</a></li>
            ...
            <div class="row">
                <form enctype="multipart/form-data" class="formulario">
                  <div class="col-xs-6 col-md-4">
                    <input class="btn btn-primary" type="button" value="Enviar" onclick="javascript:guardarchatcli()">
    ...
    ?>
      ...
      <section  style="padding: 15%;margin-top: -12%">      
        <div class="row">       
          <h1 class="text-center">Chat: <small>Bobinados Del Valle</small></h1> 
          <hr>
        </div>  
        <div class="row">
          <!--<form id="formChat" role="form" method="post">-->
